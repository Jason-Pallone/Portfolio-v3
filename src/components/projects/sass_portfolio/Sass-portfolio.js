...
const SassPortfolio =()=>
    <div className='individual-project-container'>
        ...
        <img src='./gifs/giphy-api.gif' alt='sass portfolio project' className='gif'></img>
        ...
        <img className='techStack-icon' src="http://img.icons8.com/color/48/000000/html-5.png" alt='HTML icon' />
            <DeviceIcons />
            This is a project built using Sass and HTML5. It's a basic portfolio site. You can view the about me section,
